...
> Postgres container in Docker compose runs after Go App container. It took me longer than expected to find a solution for Go App to wait for Postgres.

Did you learn anything new?
> I learned a lot about the gorm and ginkgo libraries.
